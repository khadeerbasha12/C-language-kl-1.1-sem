...
char name[200][20]={"Hydrogen","Helium","Lithium","Beryllium","Boron","Carbon","Nitrogen","Oxygen","Flourine","Neon",
...
double weight[200] ={1.00,4.00,6.94,9.01,10.81,12.01,14.00,16.00,20.00,20.18,23.00,24.31,26.99,28.08,30.97,32.06,35.45,39.09,40.07,44.95,47.86,50.94,
...
int main()
{
printf("\t\t\t\t\t\4DIGITAL MODERN PERIODIC TABLE\4\n");
	printf("\t\t\t\t\t-------------------------------\n");
...
{
	int option;
	printf("\4Enter the corresponding number :\n\n");
...
void display(int i,char ch1,char ch2)
{
	printf("\t\t\t\t\t\4DIGITAL MODERN PERIODIC TABLE\4\n");
	printf("\t\t\t\t\t-----------------------------\n\n");
	printf("\n\t\t\t\t\t\3HERE'S YOUR SEARCH RESULT\3\n\n");
	printf("\n\t\t\t\t\tAtomic Number     : %d\n",(i+1));
